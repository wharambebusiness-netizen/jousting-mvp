...
```bash
npx vitest run                              # Run all tests (830 passing as of S35)
...
- **Test count**: run `npx vitest run` (830 as of S35)
...
**Total: 830 tests** (as of S35). Run `npx vitest run` for current test counts (per-file counts drift).
