...
const ROLE_DEFAULTS = {
  ...
  'backend-dev':         { category: 'backend',       defaultModel: 'sonnet', canWrite: true,  canTest: false, frequency: 0 },
  ...
  'database-dev':        { category: 'backend',       defaultModel: 'sonnet', canWrite: true,  canTest: false, frequency: 0 },
  'debugger':            { category: 'backend',       defaultModel: 'opus',   canWrite: true,  canTest: true,  frequency: 0 },
  'dependency-manager':  { category: 'infrastructure',defaultModel: 'haiku',  canWrite: false, canTest: false, frequency: 5 },
  'devops':              { category: 'infrastructure',defaultModel: 'sonnet', canWrite: true,  canTest: true,  frequency: 5 },
  'docs-writer':         { category: 'coordination',  defaultModel: 'haiku',  canWrite: false, canTest: false, frequency: 3 },
  'engine-dev':          { category: 'backend',       defaultModel: 'sonnet', canWrite: true,  canTest: true,  frequency: 0 },
  'full-stack-dev':      { category: 'backend',       defaultModel: 'sonnet', canWrite: true,  canTest: true,  frequency: 0 },
  'game-designer':       { category: 'design',        defaultModel: 'haiku',  canWrite: false, canTest: false, frequency: 5 },
  'integration-tester':  { category: 'quality',       defaultModel: 'sonnet', canWrite: true,  canTest: true,  frequency: 0 },
  ...
  'refactorer':          { category: 'backend',       defaultModel: 'opus',   canWrite: true,  canTest: true,  frequency: 0 },
