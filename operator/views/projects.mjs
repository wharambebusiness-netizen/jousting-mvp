  ...
  return `<div class="project-card" data-root="${eDir}">
    <div class="project-card__header">
      ...
      <div class="project-card__actions">
        <button class="btn btn--sm btn--primary" data-dir="${eDir}" onclick="openProjectInTerminal(this.dataset.dir)" title="Open in Terminal" aria-label="Open project in terminal">&#x2328; Terminal</button>
