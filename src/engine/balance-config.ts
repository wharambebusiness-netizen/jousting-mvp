...
export const BALANCE = {
  ...
  // 0.8 means: Charger (STA 65) threshold = 52, Bulwark (STA 62) = 49.6.
  fatigueRatio: 0.8,
  ...
  // Old 0.3 → 0.2 → 0.18 → 0.12: reduces guard's impact subtraction to improve low-GRD archetypes at bare tier.
  ...
  // impact calculation (both joust and melee). 0.25 = 25% guard ignored.
