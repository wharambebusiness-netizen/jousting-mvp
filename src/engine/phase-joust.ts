// ============================================================
// Jousting — Joust Phase Resolution
// ============================================================
import {
  type Archetype,
  type Attack,
 ...
 *  3. Compute effective stats with final attacks
 *  4. Compute Accuracy (with scaled counters)
 *  5. Compute ImpactScore
 *  6. Check unseat both directions
 *  7. Deduct attack stamina
 */
export function resolveJoustPass(
  ...
  // Step 3: Compute effective stats with final attacks
  ...
  // Step 4: Counters + Accuracy (counter bonus scales with winner's CTL)
